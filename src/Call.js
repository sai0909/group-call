...
function Call() {
    ...
    async function issueVoIPToken() {
        const token = "eyJhbGciOiJSUzI1NiIsImtpZCI6IjEwNCIsIng1dCI6IlJDM0NPdTV6UENIWlVKaVBlclM0SUl4Szh3ZyIsInR5cCI6IkpXVCJ9..vjgUchd7ojnjwL7zVbiJSUC45X2tHfjYk54_iQBqb-kuCIj4uf6iOZFJtLeA8BFVM5-BVOUZBMCde3nSTGpt5DLeQl0HEjEfMqzkFxd8cw5eRvHR89FLDe0cr3fjcnxPKVgjJl-3r1yLm_2tyLwz4dn70foIaCPCts4dp7VZrOetbLGvNMASOcVfwu0ihQKwzoMqB8OTvSLQQ9f42amc3c9uFFE5MVrQgdpNkrHGwci_jFyA82dk8upM5Ka7bUNHTPKR-InFZo_tqceHHQUrWhEgz5Uw30ZivnG9KGlA0eB6WTX574sr10QoWpJr3CR4OY_L8EU-qVas21yj_4v9PQ";
        setVoIPToken(token);
    ...
    async function initClient(token) {
        ...
        try {
            ...
            const result = await addedDeviceManager.askDevicePermission({ audio: true, video: true });
    ...
    function startCall() {
        console.log(call);
        const locator = { meetingLink: "https://teams.microsoft.com/l/meetup-join/19%3ameeting_MzJlMTI4ZDYtODQyNy00MzA1LTlkOTEtZWRhODA4OTI0ZDM2%40thread.v2/0?context=%7b%22Tid%22%3a%223a15904d-3fd9-4256-a753-beb05cdf0c6d%22%2c%22Oid%22%3a%22aba9fe86-b0bf-4942-bdb2-fb3805cd0277%22%7d"};
